// image::./sources/1.0.0/images/figure-s158-logo.svg[S158_logo,248,120]

= IHO S-158: S-129 Validation Checks

image:https://github.com/metanorma/iho-s-158/actions/workflows/generate.yml/badge.svg["Build Status", link="https://github.com/metanorma/iho-s-158/actions/workflows/generate.yml"]

This document is available in its rendered forms here:

* https://metanorma.github.io/iho-s-158/[IHO S-158 (HTML)]

== Purpose

This is the IHO repository for developing the next edition of
the S-158: S-129 Validation Checks.
...
This repository contains the source files of S-158 standard, including:

* S-158 Ed 1.0.0 - S-129 Validation Checks
...
`sources/`::
source of the S-158 documents and models
